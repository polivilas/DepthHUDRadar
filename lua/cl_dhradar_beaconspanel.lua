...
function dhradar_ShowMenu()
	...
	PanelList = vgui.Create( "DPanelList", DermaPanel )
	...
	GeneralCategory:SetSize( W_WIDTH, DermaPanel:GetTall() / 3 )
	GeneralCategory:SetExpanded( 1 ) -- Expanded when popped up
	GeneralCategory:SetLabel( "General" )
	
	GeneralCatList = vgui.Create( "DPanelList" )
	...
	print("heightchecktolerannce")
	local GeneralHeightsCheckSlider = vgui.Create("DNumSlider")
	GeneralHeightsCheckSlider:SetText( "Show Heights tolerance (Default is 110)" )
	GeneralHeightsCheckSlider:SetMin( 50 )
	GeneralHeightsCheckSlider:SetMax( 1000 )
	GeneralHeightsCheckSlider:SetDecimals( 0 )
	GeneralHeightsCheckSlider:SetConVar("dhradar_showheights_tolerance")
	...
	GeneralCatList:AddItem( GeneralHeightsCheckSlider )        //Adds the HEIGHTS CHECK
	...
	BeaconsCategory:SetSize( W_WIDTH, DermaPanel:GetTall() / 3 )
	BeaconsCategory:SetExpanded( 1 ) -- Expanded when popped up
	BeaconsCategory:SetLabel( "Beacons" )
	
	BeaconsCatList = vgui.Create( "DPanelList" )
	...
	// MAIN BEACON LIST
	BeaconsList = vgui.Create( "DPanelList" )
	...
	UIStyleCategory:SetSize( W_WIDTH,DermaPanel:GetTall() / 3 )
	UIStyleCategory:SetExpanded( 1 ) -- Expanded when popped up
	UIStyleCategory:SetLabel( "UI Design" )
	
	UIStyleCatList = vgui.Create( "DPanelList" )
